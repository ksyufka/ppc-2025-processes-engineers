...
В тесте решается система размера \(n=120\) (диагонально-доминантная).
Для сравнения используются режимы perf `pipeline` и `task_run`, измеряемые фреймворком курса.

Замеры (запуск под `mpirun --oversubscribe -n 2`, т.е. **2 процесса**):

| Mode     | Procs | Time, s     | Speedup | Efficiency |
|----------|------:|------------:|--------:|-----------:|
| pipeline |     1 | 0.0064744473 | 1.00    | N/A        |
| pipeline |     2 | 0.0063552198 | 1.02    | 50.9%      |
| task_run |     1 | 0.0055575848 | 1.00    | N/A        |
| task_run |     2 | 0.0042985186 | 1.29    | 64.6%      |
